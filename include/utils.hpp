/**
 * @file utils.hpp
 * @brief Provides utility functions for various operations such as time
 * retrieval, signal handling, logging, and printing information.
 *
 */
...
bool startsWith(
    ...
    const std::string &prefix); // not used so far in current version

...
\hypertarget{_thread_8inl_source}{}\label{_thread_8inl_source}\index{/Users/thibault/kdrive/1-\/PROJECTS/P-\/42/push\_swap/push\_swap\_visualizer/build/\_deps/sfml-\/src/include/SFML/System/Thread.inl@{/Users/thibault/kdrive/1-\/PROJECTS/P-\/42/push\_swap/push\_swap\_visualizer/build/\_deps/sfml-\/src/include/SFML/System/Thread.inl}}
...
\DoxyCodeLine{00046\ \{}
\DoxyCodeLine{00047\ \ \ \ \ \mbox{\hyperlink{structpriv_1_1_thread_functor_with_arg}{ThreadFunctorWithArg}}(F\ function,\ \mbox{\hyperlink{class_a}{A}}\ arg)\ :\ m\_function(function),\ m\_arg(arg)\ \{\}}
...
\DoxyCodeLine{00050\ \ \ \ \ \mbox{\hyperlink{class_a}{A}}\ m\_arg;}
\DoxyCodeLine{00051\ \};}
\DoxyCodeLine{00052\ }
...
\DoxyCodeLine{00056\ \{}
\DoxyCodeLine{00057\ \ \ \ \ \mbox{\hyperlink{structpriv_1_1_thread_member_func}{ThreadMemberFunc}}(\textcolor{keywordtype}{void}(\mbox{\hyperlink{class_c}{C}}::*function)(),\ \mbox{\hyperlink{class_c}{C}}*\ \textcolor{keywordtype}{object})\ :\ m\_function(function),\ m\_object(\textcolor{keywordtype}{object})\ \{\}}
\DoxyCodeLine{00058\ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ run()\ \{(m\_object-\/>*m\_function)();\}}
\DoxyCodeLine{00059\ \ \ \ \ void(\mbox{\hyperlink{class_c}{C}}::*m\_function)();}
\DoxyCodeLine{00060\ \ \ \ \ \mbox{\hyperlink{class_c}{C}}*\ m\_object;}
\DoxyCodeLine{00061\ \};}
\DoxyCodeLine{00062\ }
...
\DoxyCodeLine{00077\ Thread::Thread(F\ function,\ \mbox{\hyperlink{class_a}{A}}\ argument)\ :}
\DoxyCodeLine{00078\ m\_impl\ \ \ \ \ \ (NULL),}
\DoxyCodeLine{00079\ m\_entryPoint(new\ priv::ThreadFunctorWithArg<F,\ \mbox{\hyperlink{class_a}{A}}>(function,\ argument))}
\DoxyCodeLine{00080\ \{}
\DoxyCodeLine{00081\ \}}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00083\ }
\DoxyCodeLine{00085\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ C>}
\DoxyCodeLine{00086\ Thread::Thread(\textcolor{keywordtype}{void}(\mbox{\hyperlink{class_c}{C}}::*function)(),\ \mbox{\hyperlink{class_c}{C}}*\ \textcolor{keywordtype}{object})\ :}
\DoxyCodeLine{00087\ m\_impl\ \ \ \ \ \ (NULL),}
\DoxyCodeLine{00088\ m\_entryPoint(new\ priv::ThreadMemberFunc<\mbox{\hyperlink{class_c}{C}}>(function,\ object))}
\DoxyCodeLine{00089\ \{}
\DoxyCodeLine{00090\ \}}
